  ...
  home: {
    ...
    banner: {
      slide1: {
        ...
        text: "	5-	نوفر لك الذكاء الاصطناعي والبيانات الدقيقة التي تحتاجها لإدارة أسطولك وتتبع مركباتك في أصعب الظروف. نحن نجمع لك كل البيانات المبعثرة ونعرضها في لوحة تحكم واحدة لنمنحك السيطرة الكاملة.",
      ...
      slide3: {
        ...
        title: "توفر شركة باور أوربت ",
        titleHighlight: "Orbit (DMS سابقاً) ",
        titleEnd: "شركة تقنية سعوديةحلول تتبع المركبات مع بنية تحتية متطورة معززة بتطبيقات إنترنت الأشياء (IoT)، تمنحك حلول وأنظمة باور أوربت الدقة والكفاءة العالية التي تحتاجها لإدارة أسطولك في المهام الحساسة والصعبة.",
