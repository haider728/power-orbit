...
const en = {
  ...
  home: {
    ...
    banner: {
      ...
      slide2: {
        subtitle: "IoT Solutions Designed for Your Success",
      ...
      items: [
        {
          ...
          bestFor: [
            ...
            { icon: "landmark", label: "Government transport authorities" },
            { icon: "bus", label: "Large-scale commercial fleets" },
          ],
        },
        {
          ...
          bestFor: [
            { icon: "hospital", label: "Healthcare warehouses" },
            { icon: "snowflake", label: "Pharmaceutical cold storage" },
            { icon: "utensils", label: "Food & beverage distributors" },
            { icon: "thermometer", label: "Sensitive environmental monitoring" },
          ],
        },
        {
          ...
          bestFor: [
            { icon: "truck", label: "Fleet operations teams" },
            { icon: "smartphone", label: "Field drivers & dispatchers" },
            { icon: "bus", label: "Transit & mobility operators" },
          ],
        },
      ],
    },
  ...
  home: {
    ...
    banner: {
      ...
      slide3: {
        ...
        title: "توفر شركة  ",
        titleHighlight: "Power Orbit باور أوربت ",
        titleEnd: "(DMS سابقاً)حلول تتبع المركبات ",
        text: "مع بنية تحتية متطورة معززة بتطبيقات إنترنت الأشياء (IoT)، تمنحك حلول وأنظمة باور أوربت الدقة والكفاءة العالية التي تحتاجها لإدارة أسطولك في المهام الحساسة والصعبة.",
        cta1: "تفضل بزيارة Eagle-IoT",
        cta1Href: "https://avl-ksa.com/",
        cta2: "تعرّف على المنظومة الكاملة",
        cta2Href:
      ...
      stats: [
        { value: "19+", label: "معتمد من الهيئة العامة للغذاء والدواء SFDA" },
        { value: "3", label: "منصات متخصصة" },
        { value: "24/7", label: "مراقبة فورية لجميع عمليات التشغيل" },
      ],
      highlights: [
        "إدارة ذكية للنقل والمركبات",
        "مراقبة ظروف البيئة والتخزين مع تقنيات إنترنت الأشياء IOT",
        "مزايا الاتصال والمراقبة بالفيديو عن بعد (التليماتيك)",
      ],
    },
    about: {
      ...
      items: [
        {
          ...
          description:
            "تقدم لك منصة ايغل-آى او تي Eagle-IoT المعتمدة من الهيئة العامة للنقل (TGA) خدمات إدارة الأساطيل وتتبع المركبات في المملكة العربية السعودية. تجمع المنصة بسلاسة بين تتبع المركبات الفوري (GPS) وتحليل سلوك السائقين وإصدار تقارير الامتثال، بما يلبي الاشتراطات الحكومية تلقائياً وبدون عناء.",
          fullDescription:
          ...
          bestFor: [
            { icon: "truck", label: "شركات الخدمات اللوجستية" },
            { icon: "landmark", label: "هيئات النقل الحكومية" },
            { icon: "bus", label: "أساطيل النقل التجاري الكبرى" },
          ],
        },
        {
          title: "سمارت سينس SmartSense | النظام الذكي لمراقبة سلاسل التبريد ودرجات الحرارة",
          description:
            "عندما يعتمد نجاح عملك على الالتزام الصارم باشتراطات هيئة الغذاء والدواء (SFDA) والحفاظ على سلامة المنتجات المخزنة، يأتي دور سمارت سينس SmartSense  ليمنحك الرؤية الشاملة والتحكم الكامل. يراقب النظام درجات الحرارة والرطوبة تلقائياً لحظة بلحظة، نظام ذكي مصمم لخدمة مرافق التخزين الثابتة وخدمات النقل المبرد والمرافق اللوجستية ومنشآت التخزين البارد في جميع أنحاء المملكة.",
          fullDescription:
          ...
          bestFor: [
            { icon: "hospital", label: "مخازن الأدوية والرعاية الصحية" },
            { icon: "snowflake", label: "تخزين الأدوية المبرّد" },
            { icon: "utensils", label: "توزيع الأغذية والمشروبات" },
            { icon: "thermometer", label: "مراقبة البيئات الحساسة" },
          ],
        },
        {
          ...
          bestFor: [
            { icon: "truck", label: "فرق إدارة الأساطيل" },
            { icon: "smartphone", label: "السائقون وفرق التوجيه الميداني" },
            { icon: "bus", label: "مشغّلو النقل والتنقل" },
          ],
        },
      ],
    },
    compliance: {
      title: "موثوق به من قبل كبرى المؤسسات ",
      titleHighlight: "حيث لا مجال للفشل",
      description:
        "تُطبَّق حلول باور أوربت في المؤسسات التي تدير عمليات واسعة النطاق، وعالية المخاطر، وحساسة للوقت.",
      badges: [
      ...
      footer:
        'آلاف المركبات. ملايين نقاط البيانات. دون أي هامش للخطأ',
    },
    choose: {
