...
const cardsAr: ProjectCard[] = [
  {
    ...
    description:
      "2-	تقدم لك منصة ايغل-آى او تي Eagle-IoT المعتمدة من الهيئة العامة للنقل (TGA) خدمات إدارة الأساطيل وتتبع المركبات في المملكة العربية السعودية. تجمع المنصة بسلاسة بين تتبع المركبات الفوري (GPS) وتحليل سلوك السائقين وإصدار تقارير الامتثال، بما يلبي الاشتراطات الحكومية تلقائياً وبدون عناء.",
    fullDescription:
